...
var _x2JsJs = require("./x2js.js");
var _x2JsJsDefault = parcelHelpers.interopDefault(_x2JsJs);
var _configJs = require("./config.js");
var _configJsDefault = parcelHelpers.interopDefault(_configJs);
var _utilsJs = require("./utils.js");
const x2js = new (0, _x2JsJsDefault.default)();
let json = {};
const convertObjectsIntoArrays = (json)=>{
    if (!Array.isArray(json.treebank.sentence)) json.treebank.sentence = [
        json.treebank.sentence
    ];
    json.treebank.sentence.forEach((w, i)=>{
        if (!Array.isArray(w.word)) json.treebank.sentence[i].word = [
            w.word
        ];
    });
    return json;
...
const xmlToTable = (xml)=>{
    ...
    if (!atts.length) atts = Object.keys(json.treebank.sentence[0].word[0]).map((key)=>key.substring(1));
    jsonToXml();
    return `
        <table>
            <tr class="th-row">
...
const updateJsonState = (el)=>{
    ...
    if (el.innerText != el.dataset.original) el.classList.add("modified");
    else el.classList.remove("modified");
    jsonToXml();
};
const jsonToXml = ()=>{
    const newXml = x2js.js2xml(json);
    const newXmlPrettified = (0, _utilsJs.prettifyXml)(newXml);
    document.getElementById("target").value = newXmlPrettified;
};
document.addEventListener("DOMContentLoaded", ()=>{
    const container = document.getElementById("tokens");
    document.addEventListener("input", function(e) {
        if (e.target.matches("td")) (0, _utilsJs.debounce)(()=>updateJsonState(e.target))();
        else if (e.target.matches("#origin")) (0, _utilsJs.debounce)(()=>container.innerHTML = xmlToTable(e.target.value))();
    });
});

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./config.js":"jtCLN","./x2js.js":"7IvGC","./utils.js":"en4he"}],"gkKU3":[function(require,module,exports) {
...
exports.default = includeAtts = [];

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7IvGC":[function(require,module,exports) {
/*
...
},{"./conventions":"hb2CV"}],"en4he":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "prettifyXml", ()=>prettifyXml);
